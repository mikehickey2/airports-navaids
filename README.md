...
**Status:** Active &nbsp;·&nbsp; **Version:** 2.1.1 &nbsp;·&nbsp; **Software Date:** 2026-08-10 &nbsp;·&nbsp; **NASR Database Date:** <!-- pipeline:faa_date -->2026-09-03<!-- /pipeline:faa_date --> &nbsp;·&nbsp; **Author:** Mike Hickey  
...
This key is **read-only** - you can query all <!-- pipeline:airports_count -->19,411<!-- /pipeline:airports_count --> facilities and <!-- pipeline:navaids_count -->1,617<!-- /pipeline:navaids_count --> navaids but cannot modify data. See [API Access](#api-access) for more examples.
...
**Current Data:**
- <!-- pipeline:airports_count -->19,411<!-- /pipeline:airports_count --> facilities
- <!-- pipeline:navaids_count -->1,617<!-- /pipeline:navaids_count --> navaids
...
│   ├── parquet_schema.R           # Parquet type coercion for the cleaning layer
