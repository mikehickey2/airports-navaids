...
**NASR Database Date:** <!-- pipeline:faa_date -->2026-03-19<!-- /pipeline:faa_date -->  
**Author:** Mike Hickey  
...
This key is **read-only** - you can query all <!-- pipeline:airports_count -->5,309<!-- /pipeline:airports_count --> airports and <!-- pipeline:navaids_count -->1,639<!-- /pipeline:navaids_count --> navaids but cannot modify data. See [API Access](#api-access) for more examples.
...
- <!-- pipeline:navaids_count -->1,639<!-- /pipeline:navaids_count --> navaids
